...
1. 主题人物 / 概念（Information Pioneer / Turing / 鲁迅…）
2. 核心理论 / 公式 / 模型（决定中央图示）
...
```json
{
  ...
  "subject": "{argument name=\"subject\" default=\"Information Pioneer and information theory\"}",
  "style": {
  ...
  "poster": {
    "headline": "{argument name=\"headline\" default=\"Information Pioneer — The Architecture of Information\"}",
  ...
  "visualElements": {
    "portrait": {
      "subject": "{argument name=\"portrait subject\" default=\"Information Pioneer\"}",
