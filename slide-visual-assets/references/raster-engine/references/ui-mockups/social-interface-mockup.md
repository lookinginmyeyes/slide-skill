...
```json
{
  ...
  "post": {
    "author": {
      "display_name": "{argument name=\"brand name\" default=\"Reference Lab\"}",
      "verified_badge": "official-gold",
      "handle": "{argument name=\"handle\" default=\"@Reference LabAI\"}"
    },
    "content": {
      "text": "{argument name=\"announcement text\" default=\"Today we're introducing AI model 4.7 — our most capable model yet for coding and complex reasoning.\"}",
      "media_grid": {
        "count": 1,
        "images": ["产品发布主视觉，带 '{argument name=\"product name\" default=\"AI model 4.7\"}' 大字"]
      }
    },
    "metadata": {
