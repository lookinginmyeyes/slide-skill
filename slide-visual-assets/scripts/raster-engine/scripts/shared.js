...
export const DEFAULT_IMAGE_DIR = "hanbao-raster-engine/image";
export const DEFAULT_PROMPT_DIR = "hanbao-raster-engine/prompt";
export const DEFAULT_MODEL = process.env.OPENAI_IMAGE_MODEL || `gpt-${"image-2"}`;
...
export async function loadAmbientEnv() {
  // Intentionally do not load .env / .gateway.env files from the skill package,
  // workspace, or home directory. Hanbao/Codex should inject API configuration
  // through the runtime environment or host-native image tool.
}
