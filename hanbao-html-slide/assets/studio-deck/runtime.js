...
(function () {
  ...
  ready(function () {
    ...
    const CHANNEL_NAME = 'studio-deck-presenter-' + location.pathname;
    let bc;
    ...
    function openPresenterWindow() {
      ...
      presenterWin = window.open('', 'studio-deck-presenter', 'width=1280,height=820,menubar=no,toolbar=no');
      if (!presenterWin) {
    ...
    function buildPresenterHTML(deckUrl, slideMeta, total, startIdx, channelName, currentTheme) {
      ...
      const storageKey = 'studio-deck-presenter:' + location.pathname;
