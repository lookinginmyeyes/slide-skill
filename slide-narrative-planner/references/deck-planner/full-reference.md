...
### scripts/chartkit.py
**Minimal chart renderer** for deck-planner.
...
- This skill **complements** (not conflicts with) built-in built-in PowerPoint generation capabilities. Use this skill to produce "high-quality structure & content," then optionally invoke system capabilities to export the final PPTX file.
- For complex data analysis needs, combine with other skills (e.g., data analysis, charting) before invoking deck-planner.
