...
```bash
bash .cursor/skills/click-story/scripts/scaffold.sh --list-themes
```
...
```bash
cp .cursor/skills/click-story/themes/newsroom/tokens.css \
...
```bash
cd .cursor/skills/click-story/themes
